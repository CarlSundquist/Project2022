...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Skapa error report database
        errorReportDB = Room.databaseBuilder(getApplicationContext(), ErrorReportDatabase.class, "error_reports_db")
                .allowMainThreadQueries()
                .build();
        errorReportDao = errorReportDB.errorReportDao();

        Log.d("MainActivity", "ErrorReportDatabase skapad och errorReportDao initierad.");
