...
public class UpdateActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button errorReportButton = findViewById(R.id.buttonErrorReport);
        errorReportButton.setOnClickListener(v -> {
            Intent intent_error = new Intent(UpdateActivity.this, ErrorReportActivity.class);
